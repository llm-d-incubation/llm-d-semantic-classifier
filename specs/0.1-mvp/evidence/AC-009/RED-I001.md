...
(integration) and S-001/S-002 (OpenShift system). This turn focuses on I-001
(the real tonic client/server round trip). I-002 (persistent channel) stays wired
and green in the same file; I-005/I-006/I-008 (dummy-Praxis semantics) and
...
Praxis client can consume responses from. No such layer existed — no proto, no
